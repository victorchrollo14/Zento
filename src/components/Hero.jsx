...
export const HeroContent = () => {
  return (
    <div className="hero-content  mt-8 flex flex-col md:justify-center md:items-center lg:items-start">
      <h1 className="md:text-center lg:text-left">
        <Typewriter
          onInit={(typewriter) => {
            typewriter
              .typeString("Banking Reimagined... <br />")
              .typeString(
                'For the <span class="text-light-green md:text-center">Gen-Z.</span> <br />'
              )
              .typeString(
                'By the <span class="text-light-green md:text-center">Gen-Z.</span>'
              )
              .start()
          }}
          options={{
