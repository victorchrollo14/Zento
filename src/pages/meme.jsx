...
const Meme = () => {
  return (
    <>
      <Header />
      <motion.div
        className="min-h-screen overflow-hidden bg-light-green"
        initial={{ y: "100%" }}
        animate={{ y: "0%" }}
        exit={{ opacity: 1 }}
        ...
        <section className="meme-section   bg-light-green text-drkPurple">
          <div className="content flex flex-col gap-4 justify-center items-center mt-24 py-10">
            ...
            <h1 className="font-mont p-4 md:max-w-[80%] lg:max-w-[50%] text-center text-base  sm:text-lg sm:font-semibold">
              ...
              our platform in a closed beta stage. We're taking a little extra
              time to ensure everything is perfect before unveiling it to you.
              Stay tuned for an exceptional banking experience coming your way
              soon! 🤞🏻🤞🏻🤞🏻
            </h1>
          </div>
        </section>
